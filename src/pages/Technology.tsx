                  ...
                  <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-200 h-full">
                    ...
                    <div className="group">
                      ...
                      <div className="relative overflow-hidden rounded-lg border border-gray-300 cursor-pointer">
                        <img src="/lovable-uploads/6051146c-9732-4c2d-93eb-935c1df06056.png" alt="CareSanctum Emergency Response Dashboard" className="w-full h-24 object-cover transition-all duration-500 group-hover:fixed group-hover:top-1/2 group-hover:left-1/2 group-hover:transform group-hover:-translate-x-1/2 group-hover:-translate-y-1/2 group-hover:w-[800px] group-hover:h-[500px] group-hover:z-50 group-hover:bg-white group-hover:p-4 group-hover:rounded-lg group-hover:shadow-2xl group-hover:border-4 group-hover:border-primary group-hover:object-contain" />
